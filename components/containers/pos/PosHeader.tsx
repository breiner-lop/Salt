...
const PosHeader: NextPage<any> = ({data}) => {
  return <div style={{ backgroundImage:`url(${data.backgroundImage})`}} className="text-white pt-32 md:px-14 px-5  bg-center bg-cover bg-no-repeat h-[638px] flex items-center">
  <div>

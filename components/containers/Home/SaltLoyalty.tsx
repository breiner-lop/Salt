...
const SaltLoyalty: NextPage<Props> = ({}) => {
  return <div className="flex px-14 py-10 relative w-full">
    <div className="h-80 absolute z-10 w-4/5 left-0 bg-gradient-to-tr from-[#232324] to-[#1E3534] my-auto top-0 bottom-0"></div>
  <div className="bg-[#262626] w-[65%] rounded-2xl px-10 py-20 text-white pr-24 z-20 shadow-xl ml-[35%]">

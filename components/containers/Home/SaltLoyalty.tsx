...
const SaltLoyalty: NextPage<Props> = ({ loyaltyData }) => {
  ...
  <div className="bg-[#262626] md:w-[65%] rounded-2xl md:px-10 px-5 py-20 text-white md:pr-24 z-20 shadow-xl md:ml-[35%]">
    ...
    <motion.h2 variants={itemVariants} className="md:text-5xl text-4xl mt-2">{ loyaltyData.title }</motion.h2>
    <motion.p
     variants={itemVariants} className="text-[#9E9E9E] mt-5 lg:w-[550px]"
     dangerouslySetInnerHTML={{__html: loyaltyData.description }}
 />

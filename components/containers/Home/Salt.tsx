...
const Salt: NextPage<Props> = ({}) => {
  return <div className='md:px-14 px-5 md:py-40 py-20 bg-[url(/images/saltplan.png)] bg-cover bg-no-repeat text-white'>
    <Image src="/images/logosalt.svg" alt="logo" width={150} height={78} className="mx-auto mb-2"/>
    <p className='text-center md:w-[620px] mx-auto'>Salt is trusted by the largest and highest volume retail chains due to our consistency 
...
<div className='grid md:grid-cols-3 grid-cols-1 mt-20'>
    <div className='text-center'>
        ...
        <p className='text-[#D0D0D0] w-40 mx-auto leading-4 font-semibold'>Active Retail Locations</p>
        <hr className='w-16 mx-auto mt-3'/>
    </div>
    <div className='text-center'>
        <p className='font-bold text-3xl w-40 mx-auto mb-2'>$5.16B</p>
        <p className='text-[#D0D0D0] w-48 mx-auto leading-4 font-semibold'>Gross Merchandise Value Processed</p>
        <hr className='w-16 mx-auto mt-3'/>
    </div>
    <div className='text-center'>
        <p className='font-bold text-3xl w-40 mx-auto mb-2'>13,211</p>
        <p className='text-[#D0D0D0] w-40 mx-auto leading-4 font-semibold'>Active Payment Terminals</p>
        <hr className='w-16 mx-auto mt-3'/>
    </div>
